...
class UAEL_Config {
	...
	public static function get_widget_list() {
		if ( null === self::$widget_list ) {
			...
			self::$widget_list = array(
				...
				'Woo_Thank_You'       => array(
					'slug'        => 'uael-woo-thank-you',
					'title'       => __( 'Woo - Thank You Page', 'uael' ),
					'description' => __( 'Create custom WooCommerce thank you pages with order details.', 'uael' ),
					'keywords'    => array( 'uael', 'woo', 'thank you', 'thankyou', 'order', 'checkout', 'woocommerce' ),
					'icon'        => 'uael-icon-woo-thank-you',
					'title_url'   => '#',
					'default'     => true,
					'doc_url'     => UAEL_DOMAIN . 'docs-category/widgets/woo-thank-you/?utm_source=uael-pro-dashboard&utm_medium=uael-menu-page&utm_campaign=uael-pro-plugin',
					'category'    => 'woo',
					'is_pro'      => true,
					'demo_url'    => UAEL_DOMAIN . 'widgets/woo-thank-you/',
				),
				'FfStyler'            => array(
					'slug'        => 'uael-ff-styler',
				...
				'SVG_Animator'        => array(
					'slug'        => 'uael-svg-animator',
					'title'       => __( 'SVG Animator', 'uael' ),
					'description' => __( 'Create drawing animations for SVG files with various timing options.', 'uael' ),
					'keywords'    => array( 'uael', 'svg', 'animator', 'animation', 'drawing', 'path' ),
					'icon'        => 'uael-icon-SVG-Animator',
					'title_url'   => '#',
					'default'     => true,
					'doc_url'     => UAEL_DOMAIN . '/docs-category/widgets/svg-animator/?utm_source=uael-pro-dashboard&utm_medium=uael-menu-page&utm_campaign=uael-pro-plugin',
					'category'    => 'creative',
					'is_pro'      => true,
					'demo_url'    => UAEL_DOMAIN . 'widgets/svg-animator/',
				),
	...
	public static function get_widget_script() {
		...
		$js_files = array(
			...
			'uael-svg-animator'      => array(
				'path'      => 'assets/' . $folder . '/uael-svg-animator' . $suffix . '.js',
				'dep'       => array( 'jquery' ),
				'in_footer' => true,
			),
			'uael-nav-menu'          => array(
