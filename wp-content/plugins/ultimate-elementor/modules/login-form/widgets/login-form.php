		...
		// Turnstile Security Control.
			$this->add_control(
				...
				array(
					...
					'return_value' => 'yes',
					'separator'    => 'before',
					'description'  => __( 'Enable Cloudflare Turnstile security verification for this login form.', 'uael' ),
				)
			);
				...
				<form class="uael-form uael-login-form" method="post">
					...
					<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'wrapper' ) ); ?>>
						...
						<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'submit-group' ) ); ?>>
							<?php
								/**
								 * Fires immediately before the Login form’s submit button.
								 */
								do_action( 'uael_login_form_before_submit_button', $settings, $node_id );
							...
							if ( ! empty( $settings['enable_turnstile'] ) && 'yes' === $settings['enable_turnstile'] ) {
								...
								if ( $turnstile->is_login_turnstile_enabled() ) {
									$turnstile->render_turnstile_widget( 'login', $node_id );
								}
							}
							?>
