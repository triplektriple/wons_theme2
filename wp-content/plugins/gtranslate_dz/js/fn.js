(function(){
    ...
    var u_class = '.gt_container-'+Array.from('fn'+wrapper_selector).reduce(function(h,c){return 0|(31*h+c.charCodeAt(0))},0).toString(36);
    ...
    function get_flag_src(lang) {
        if (lang=="dz")
            return "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Flag_of_Bhutan.svg/800px-Flag_of_Bhutan.svg.png"
        else if(!alt_flags[lang])
