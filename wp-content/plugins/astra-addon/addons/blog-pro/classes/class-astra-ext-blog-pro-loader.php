...
if ( ! class_exists( 'Astra_Ext_Blog_Pro_Loader' ) ) {
	...
	class Astra_Ext_Blog_Pro_Loader {
		...
		public function theme_defaults( $defaults ) {
			...
			$defaults['blog-card-content-alignment-h'] = '';
			$defaults['blog-card-content-alignment-v'] = '';

			// More Blog Pro Options
			$defaults['post-card-height']                     = '';
			$defaults['post-card-content-text-border-radius'] = array(
				'desktop'      => array(
					'top'    => '',
					'right'  => '',
					'bottom' => '',
