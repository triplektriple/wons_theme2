	...
	class Astra_Customizer_Blog_Pro_Configs extends Astra_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				...
				/**
				 * Option: Blog Card Content Alignment
				 */
				array(
					'name'     => ASTRA_THEME_SETTINGS . '[blog-card-content-alignment-heading]',
					'section'  => 'section-blog',
					'title'    => __( 'Blog Card Content Alignment', 'astra-addon' ),
					'type'     => 'control',
					'control'  => 'ast-heading',
					'priority' => 125,
					'settings' => array(),
				...
				/**
				 * Option: Blog Card Content Alignment - Horizontal
				 */
				array(
					'name'       => ASTRA_THEME_SETTINGS . '[blog-card-content-alignment-h]',
					'default'    => astra_get_option( 'blog-card-content-alignment-h' ),
					'type'       => 'control',
					'priority'   => 125,
					'control'    => 'ast-selector',
					'section'    => 'section-blog',
					'title'      => __( 'Horizontal Alignment', 'astra-addon' ),
					'choices'    => array(
						''       => __( 'None', 'astra-addon' ),
						'left'   => __( 'Left', 'astra-addon' ),
						'center' => __( 'Center', 'astra-addon' ),
				...
				/**
				 * Option: Blog Card Content Alignment - Vertical
				 */
				array(
					'name'       => ASTRA_THEME_SETTINGS . '[blog-card-content-alignment-v]',
					'default'    => astra_get_option( 'blog-card-content-alignment-v' ),
					'type'       => 'control',
					'priority'   => 125,
					'control'    => 'ast-selector',
					'section'    => 'section-blog',
					'title'      => __( 'Vertical Alignment', 'astra-addon' ),
					'choices'    => array(
						''       => __( 'None', 'astra-addon' ),
						'top'    => __( 'Top', 'astra-addon' ),
						'middle' => __( 'Middle', 'astra-addon' ),
						'bottom' => __( 'Bottom', 'astra-addon' ),
					),
					'renderAs'   => 'text',
					'responsive' => false,
					...
					'context'    => array(
						...
						array(
							'setting'  => ASTRA_THEME_SETTINGS . '[blog-layout]',
							'operator' => '!==',
							'value'    => array( 'blog-layout-1', 'blog-layout-4', 'blog-layout-5' ),
						),
					),
				),

				/**
				 * Option: Blog Category Alignment Heading
				 */
				array(
					'name'     => ASTRA_THEME_SETTINGS . '[blog-category-alignment-heading]',
					'section'  => 'section-blog',
					'title'    => __( 'Blog Category Alignment', 'astra-addon' ),
					'type'     => 'control',
					'control'  => 'ast-heading',
					'priority' => 126,
					'settings' => array(),
					...
					'context'  => array(
						...
						array(
							'setting'  => ASTRA_THEME_SETTINGS . '[blog-layout]',
							'operator' => 'in',
							'value'    => array( 'blog-layout-4', 'blog-layout-5', 'blog-layout-6' ),
						),
					),
				),

				/**
				 * Option: Blog Category Alignment - Horizontal
				 */
				array(
					'name'       => ASTRA_THEME_SETTINGS . '[blog-category-alignment-h]',
					'default'    => astra_get_option( 'blog-category-alignment-h' ),
					'type'       => 'control',
					'priority'   => 126,
					'control'    => 'ast-selector',
					'section'    => 'section-blog',
				...
				/**
				 * Option: Blog Category Alignment - Vertical
				 */
				array(
					'name'       => ASTRA_THEME_SETTINGS . '[blog-category-alignment-v]',
					'default'    => astra_get_option( 'blog-category-alignment-v' ),
					'type'       => 'control',
					'priority'   => 127,
					'control'    => 'ast-selector',
					'section'    => 'section-blog',
				...
				/**
				 * Option: Post Card Height
				 * Location: Custom Post Types > Blog / Archive > Design > Post Cards
				 */
				array(
					'name'              => ASTRA_THEME_SETTINGS . '[post-card-height]',
					'section'           => 'section-blog',
					'transport'         => 'postMessage',
					'default'           => astra_get_option( 'post-card-height' ),
					'reset_value'       => '',
					'allow_reset'       => true,
					'priority'          => 2.5,
					'title'             => __( 'Card Height', 'astra-addon' ),
					'suffix'            => 'px',
					'type'              => 'control',
					'control'           => 'ast-slider',
					'input_attrs'       => array(
				...
				/**
				 * Option: Post Content Divider
				 * Location: Custom Post Types > Blog / Archive > Design > Post Content
				 */
				array(
					'name'     => ASTRA_THEME_SETTINGS . '[blog-post-card-content-divider]',
					'section'  => 'section-blog',
					'title'    => __( 'Post Content', 'astra-addon' ),
					'type'     => 'control',
					'control'  => 'ast-heading',
					'priority' => 3,
					'context'  => array(
				...
				/**
				 * Option: Post Content Text Border Radius
				 * Location: Custom Post Types > Blog / Archive > Design > Post Content
				 */
				array(
					'name'           => ASTRA_THEME_SETTINGS . '[post-card-content-text-border-radius]',
					'default'        => astra_get_option( 'post-card-content-text-border-radius' ),
					'type'           => 'control',
					'control'        => 'ast-responsive-spacing',
					'transport'      => 'postMessage',
					'section'        => 'section-blog',
					'title'          => __( 'Text Border Radius', 'astra-addon' ),
					'suffix'         => 'px',
					'priority'       => 3.5,
					'context'        => array(
						astra_addon_builder_helper()->design_tab_config,
