		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				...
				array(
					...
					'divider'     => array( 'ast_class' => 'ast-top-divider ast-bottom-section-divider icon-divider' ),
					'context'     => array(
						astra_addon_builder_helper()->general_tab_config,
						array(
							'setting'  => ASTRA_THEME_SETTINGS . '[single-post-social-sharing-icon-enable]',
				...
				/**
				 * Option: Inherit Blog Card Style for Related Posts
				 */
				array(
					'name'        => ASTRA_THEME_SETTINGS . '[related-posts-inherit-card-style]',
					'default'     => astra_get_option( 'related-posts-inherit-card-style' ),
					'type'        => 'control',
					'section'     => 'ast-sub-section-related-posts',
					'title'       => __( 'Inherit Blog Card Style', 'astra-addon' ),
					...
					'description' => __( 'When enabled, applies blog card content alignment (horizontal & vertical) options to related posts cards.', 'astra-addon' ),
				),
			);
